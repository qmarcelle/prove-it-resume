...
export const DECISION_RECEIPTS: readonly DecisionReceipt[] = [
  {
    ...
    constraint:
      'Repository intelligence had to reach a coding host, Codex first and then Claude Code, without polluting its context, without write access, and without the host repository taking a dependency on a private daemon. Two surfaces could carry it: an MCP server, or a repo-native CLI the agent shells out to.',
    alternatives: [
